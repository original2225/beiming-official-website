...
@SpringBootTest(classes = cn.beiming.portalcore.PortalCoreServiceApplication.class, properties = {"server.port=8134", "portal-core.test-controls.enabled=true"})
...
class GuideApiContractTest {
    ...
    void auditOpsCompatibilityContract() throws Exception {
        ...
        assertThat(ops.at("/data/port").asInt()).isEqualTo(8134);
        assertThat(ops.at("/data/legacyPort").asInt()).isEqualTo(8127);
        ...
        String source = java.nio.file.Files.readString(java.nio.file.Path.of("src/main/java/cn/beiming/guide/GuideModule.java"));

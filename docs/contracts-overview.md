...
| 第五批玩家门户体验 | `backend/portal-core-service` | 8134 | `guide`、`material`、`online-map` | `8127`、`8126` 和 `8121` 为历史原端口；`guide` 和 `material` 旧服务目录已退役且不得恢复，旧 `online-map` 服务目录待用户明确确认后再逐文件清理 |

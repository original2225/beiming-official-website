...
| 模块 | 端口 | 用途 |
| --- | ---: | --- |
| auth | 8101 | 登录、注册、当前用户、会话、密码、邀请码、角色、Minecraft 绑定 |
| profile | 8102 | 成员公开档案、当前用户档案、后台成员维护 |
| notification | 8103 | 站内通知、未读数、已读、归档、模板维护 |
| content | 8104 | 首页内容、公告文章、专题、SEO、分类标签 |
| server-status | 8105 | 玩家可见服务器状态、线路、历史快照 |
| resource | 8106 | 资源展示、资源版本、下载票据、Cloudreve 分享 |
| admin | 8107 | 后台首页、待办、配置、审计、数据看板 |
| onboarding | 8108 | 入服进度、步骤完成、规则确认 |
| exam | 8109 | 考试方向、题库、试卷、答题、阅卷 |
| whitelist | 8110 | 白名单申请、补充、撤回、审核、移除 |
| attendance | 8111 | 考勤积分、积分流水、榜单、月度任务 |
| community | 8112 | 板块、帖子、评论、点赞、收藏、投票、举报、工单、处罚 |
| activity | 8113 | 活动列表、报名、签到、结果、奖励 |
| calendar | 8114 | 日程、维护窗口、工程节点、提醒 |
| changelog | 8115 | 更新日志、维护日志、插件变更、规则调整 |

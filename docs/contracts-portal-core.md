...
| `online-map` | `backend/online-map-service` | 8121 | `backend/portal-core-service` | 8134 | 34 | `docs/contracts-online-map.md` | 已退役，不得恢复旧 Maven 入口 | `mvn -q -f backend/portal-core-service/pom.xml test` |
